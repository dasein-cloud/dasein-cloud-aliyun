 ...
 * @since 2015.05.1
 */
public class AliyunMachineImageCapabilities extends AbstractCapabilities<Aliyun> implements ImageCapabilities {

    public AliyunMachineImageCapabilities(@Nonnull Aliyun provider) {
        super(provider);
    }
    ...
    public VisibleScope getImageVisibleScope() {
        return null; //Aliyun images are associated with region, but as there is private image, so return null
    }
